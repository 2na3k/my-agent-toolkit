...
class TestAIClientWrapper:
    ...
    def test_init_with_default_provider(
        self, mock_openai_class, mock_load_dotenv, temp_config_file, mock_env_vars
    ):
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_init_with_specific_provider(
        self, mock_openai_class, mock_load_dotenv, temp_config_file, mock_env_vars
    ):
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_init_with_custom_kwargs(
        self, mock_openai_class, mock_load_dotenv, temp_config_file, mock_env_vars
    ):
        ...
        wrapper = AIClientWrapper(
            provider="claude", config_path=temp_config_file, timeout=120, max_retries=5
        )
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_chat_completion_with_defaults(
        self,
        mock_openai_class,
        mock_load_dotenv,
        temp_config_file,
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_chat_completion_with_custom_params(
        self,
        mock_openai_class,
        mock_load_dotenv,
        temp_config_file,
...
class TestClientFactory:
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_create_client_specific_provider(
        self, mock_openai_class, mock_load_dotenv, temp_config_file, mock_env_vars
    ):
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_create_all_clients_with_failure(
        self, mock_openai_class, mock_load_dotenv, temp_config_file, monkeypatch, capsys
    ):
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_create_client_for_model(
        self, mock_openai_class, mock_load_dotenv, temp_config_file, mock_env_vars
    ):
    ...
    @patch("src.core.client.load_dotenv")
    @patch("src.core.client.OpenAI")
    def test_create_client_for_model_gemini(
        self, mock_openai_class, mock_load_dotenv, temp_config_file, mock_env_vars
    ):
